...
Table.prototype.write = function(output) {
  ...
  if (this.ownerType !== null && this.ownerType !== undefined) {
    output.writeFieldBegin('ownerType', Thrift.Type.I32, 15);
    output.writeI32(this.ownerType);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem498 = null;
          elem498 = new ttypes.NotificationEvent();
          elem498.read(input);
          this.events.push(elem498);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
NotificationEventResponse.prototype.write = function(output) {
  ...
  if (this.events !== null && this.events !== undefined) {
    ...
    for (var iter499 in this.events)
    {
      if (this.events.hasOwnProperty(iter499))
      {
        iter499 = this.events[iter499];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem506 = null;
          elem506 = new ttypes.Function();
          elem506.read(input);
          this.functions.push(elem506);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
GetAllFunctionsResponse.prototype.write = function(output) {
  ...
  if (this.functions !== null && this.functions !== undefined) {
    ...
    for (var iter507 in this.functions)
    {
      if (this.functions.hasOwnProperty(iter507))
      {
        iter507 = this.functions[iter507];
