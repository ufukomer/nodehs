...
TPlanNodeExecSummary.prototype.write = function(output) {
  ...
  if (this.exec_stats !== null && this.exec_stats !== undefined) {
    ...
    for (var iter7 in this.exec_stats)
    {
      if (this.exec_stats.hasOwnProperty(iter7))
      {
        iter7 = this.exec_stats[iter7];
        iter7.write(output);
      }
    }
    output.writeListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem14 = null;
          elem14 = new ttypes.TPlanNodeExecSummary();
          elem14.read(input);
          this.nodes.push(elem14);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i20 = 0; _i20 < _size15; ++_i20)
        {
          ...
          key21 = input.readI32();
          val22 = input.readI32();
          this.exch_to_sender_map[key21] = val22;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TExecSummary.prototype.write = function(output) {
  ...
  if (this.nodes !== null && this.nodes !== undefined) {
    ...
    for (var iter30 in this.nodes)
    {
      if (this.nodes.hasOwnProperty(iter30))
      {
        iter30 = this.nodes[iter30];
        iter30.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.exch_to_sender_map !== null && this.exch_to_sender_map !== undefined) {
    ...
    for (var kiter31 in this.exch_to_sender_map)
    {
      if (this.exch_to_sender_map.hasOwnProperty(kiter31))
      {
        var viter32 = this.exch_to_sender_map[kiter31];
        output.writeI32(kiter31);
        output.writeI32(viter32);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
  ...
  if (this.error_logs !== null && this.error_logs !== undefined) {
    ...
    for (var iter33 in this.error_logs)
    {
      if (this.error_logs.hasOwnProperty(iter33))
      {
        iter33 = this.error_logs[iter33];
